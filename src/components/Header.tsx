        ...
        <div className="max-w-[768px] lg:max-w-[880px] mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div
              ...
              className={`font-bold text-xl md:text-2xl text-[#3b82f6] tracking-tight flex items-center gap-2.5 ${!isAuthScreen ? 'cursor-pointer hover:opacity-90 active:scale-98 transition-transform' : ''
                }`}
            >
